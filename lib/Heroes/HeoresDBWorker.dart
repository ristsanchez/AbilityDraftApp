...
// //forbidden names for now dota2herodata dota2 ad2data ukbest
// class _SqfliteHeroesDBWorker implements HeroesDBWorker {
//   static const String DB_NAME = 'abDota.db';
...
//   static const String KEY_ABS = 'abilities';
...
//         "INSERT INTO $TBL_NAME ($KEY_HERO_ID, $KEY_BASE_STR, $KEY_BASE_AGI, $KEY_BASE_INT, $KEY_BASE_DAMAGE_MIN, $KEY_BASE_DAMAGE_MAX, $KEY_BASE_MSPEED, $KEY_BASE_ARMOR, $KEY_NAME, $KEY_TYPE, $KEY_PRIMARY_ATTR, $KEY_SPL, $KEY_APL, $KEY_IPL, $KEY_BASE_NAME, $KEY_ABS) "
//         "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
//         [
//           hero.id,
//           hero.base_str,
